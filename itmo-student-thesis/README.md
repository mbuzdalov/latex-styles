...
Версия | Изменения
-------|----------
1.1.0.b3 | Исправлена фиксированная ширина слова ПРИЛОЖЕНИЕ в оглавлении (Issue [#2](https://github.com/mbuzdalov/latex-styles/issues/2)). Исправлена нумерация флоатов в приложениях (Issue [#6](https://github.com/mbuzdalov/latex-styles/issues/6)), нумерация списков и приложений (Issue [#8](https://github.com/mbuzdalov/latex-styles/issues/8)).
