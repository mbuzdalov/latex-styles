...
1.0.3  | Добавлена опция `page4` про нумерацию страниц. Видимо, генерацию заданий тоже надо поддерживать, скорее всего, сделаю к версии 1.1 (Issue 
[#7](https://github.com/mbuzdalov/latex-styles/issues/7)).
