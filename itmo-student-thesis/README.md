...
Версия | Изменения
-------|----------
1.3.rc1 | Реализовал `\addadvancedsoftware` для "пакетов программ и технологий". Сделал шрифты в разделах аннотации нежирными. Кажется, этим уже можно пользоваться в 2019 году.
