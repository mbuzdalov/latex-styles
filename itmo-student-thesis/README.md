...
* По-видимому, `gost-standard.bbx` несовместим с `biblatex-3.0` --- выдается ошибка такого вида:
```
...
```
По-видимому, единственное имеющееся решение --- откатиться на более раннюю версию (2.8 или 2.9).
