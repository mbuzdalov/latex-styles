...
\usepackage[implicit=false,unicode=true]{hyperref}
...
%%% Эти команды переопределяют поля про число различных публикаций
\renewcommand{\relatedworksourcecount}{1024}
\renewcommand{\russiansourcesfiveyears}{512}
\renewcommand{\russiansourcestenyears}{256}
\renewcommand{\russiansourcesveryold}{128}
\renewcommand{\foreignsourcesfiveyears}{64}
\renewcommand{\foreignsourcestenyears}{32}
\renewcommand{\foreignsourcesveryold}{16}
\renewcommand{\internetsources}{да, 44186 источников}
